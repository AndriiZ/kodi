...
RADIOS = {'JamFM': {'name': 'JamFM (95.6)', 'thumb': 'logo/jamfm.png', 'url': 'jamfm', 'desc': 'Rock station', 'genre': 'Rock'},
	  ...
	  'UR2': {'name': 'Радіо Промінь', 'thumb': 'logo/ur2.png', 'url': 'ur2', 'desc': 'Слухай українське!', 'genre': 'Talk'},
          ...
          'RadioYes': {'name': 'Радіо ЄС', 'thumb':'logos/radioyes.gif', 'url': 'radioyes', 'desc': 'Радіо європейської столиці', 'genre':'Music'},
          'BusinessRadio': {'name': 'Бізнес радіо', 'thumb': 'logos/businessradio.gif','url': 'BusinessRadio', 'desc':'Новий формат ваших рішень', 'genre': 'Music'},
	  'UR3': {'name': 'Радіо Культура', 'thumb': 'logo/ur3.png', 'url': 'ur3', 'desc': 'Канал духовного відродження', 'genre': 'Talk'},
